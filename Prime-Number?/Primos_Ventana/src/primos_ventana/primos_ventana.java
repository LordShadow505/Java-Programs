...
package primos_ventana;


public class primos_ventana extends javax.swing.JFrame {

    
    public primos_ventana() {
        initComponents();
    }
    ...
    private void rSButtonForma1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonForma1ActionPerformed
        ...
        num = Integer.parseInt(entrada.getText());
        ...
        if (cont == 2)
        {
            salida.setText(String.valueOf("Es Primo"));
        }
       
        if ((cont > 2) || (cont == 1) || (cont == 0))
        {
            salida.setText(String.valueOf("No es primo"));
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new primos_ventana().setVisible(true);
            }
        });
    }
